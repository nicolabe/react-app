import { GET_RECOMMENDED_BOOKS, GET_LOANED_BOOKS, GET_BOOK } from "./types";
...
const loanedBooks = [
  {
    ...
    image: "https://images-na.ssl-images-amazon.com/images/I/51PXthXhbiL.jpg"
  },
  {
    id: 2,
...
export const getBook = id => dispatch => {
  const book = recommendedBooks.concat(loanedBooks).find(function(item) {
